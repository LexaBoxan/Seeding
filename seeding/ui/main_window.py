...
class ImageEditor(QMainWindow):
    ...
    def on_tree_item_clicked(self, item, column):
        ...
        if item_data["type"] == "seeding":
            ...
            if not parent_data or parent_data["type"] != "seeding":
                return
            parent_idx = parent_data["parent_index"]
            seed_idx = parent_data["index"]
        else:
            return
    ...
    def classify(self) -> None:
        ...
        # Используем актуальные координаты перед классификацией
        self.save_changes()
