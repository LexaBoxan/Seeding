...
class TreeWidgetExample(QTreeWidget):
    ...
    def add_child_item(self, parent, name, description, parent_index, index, image_type, image):
        """
        ...
        child.setData(0, Qt.UserRole, {'type': 'seeding', 'parent_index': parent_index, 'index': index})
